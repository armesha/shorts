...
export const GEMINI_TTS_PRESETS = [
  {
    ...
    energy: 4,
    sampleText: "[laughs] Ну всё. [short pause] Это уже не план, это легенда.",
  },
  {
    id: "joke-storyteller",
    ...
    accent: "",
    scene: "A warm studio corner where the narrator tells a short setup directly to one viewer.",
    energy: 3,
    sampleText: "Сейчас будет короткая история. [short pause] Сначала спокойно, а финал чуть сильнее.",
  },
  {
    id: "whisper-suspense",
    label: "Шепот и пауза",
  ...
  {
    id: "confused-commentator",
    label: "Растерянный комментатор",
    voice: "Zubenelgenubi",
    style: "casual confused commentator, amused but not shouting",
    pace: "medium-fast; hesitate on the first sentence, then become more certain",
    accent: "",
    scene: "A quick reaction recorded over a strange vertical clip.",
    energy: 3,
    sampleText: "Я сначала вообще не понял, что происходит. [short pause] А потом понял, что лучше бы не понимал.",
  },
  {
    id: "cinematic-reveal",
    label: "Киношный финал",
    voice: "Gacrux",
    style: "mature cinematic narrator, dramatic but controlled",
    pace: "slow opening, short pause before the reveal, firm ending",
    accent: "",
    scene: "A small cinematic reveal voiceover for a vertical short.",
    energy: 3,
    sampleText: "[very slow] Все выглядело нормально. [short pause] До последней секунды.",
  },
  {
    id: "soft-irony",
    label: "Мягкая ирония",
    voice: "Vindemiatrix",
    style: "gentle ironic narrator with a small smile",
    pace: "medium; keep the irony light and friendly",
    accent: "",
    scene: "A calm voiceover for a short meme with a subtle punchline.",
    energy: 2,
    sampleText: "Да, конечно. [sighs] Именно так все взрослые люди и решают проблемы.",
  },
  {
    id: "high-energy-hook",
    label: "Хук с энергией",
    voice: "Fenrir",
    style: "excitable short-form host, direct and punchy",
    pace: "fast; start strong, keep pauses short, land the last words clearly",
    accent: "",
    scene: "A high-retention opening line for Shorts.",
    energy: 5,
    sampleText: "[excited] Стой, не листай. [short pause] Тут финал страннее, чем начало.",
  },
  {
    id: "dry-office",
    label: "Офисный deadpan",
    voice: "Schedar",
    style: "flat office deadpan, tired but precise",
    pace: "medium-slow; almost no emotion until the last phrase",
    accent: "",
    scene: "A dry office-style reaction voiceover.",
    energy: 2,
    sampleText: "Отличная идея. [sarcastic] Запишем ее в список решений, которые точно не сработают.",
  },
  {
    id: "breathy-secret",
    label: "Секрет на микрофон",
    voice: "Enceladus",
    style: "breathy intimate narrator, quiet and close to the microphone",
    pace: "slow; keep the pauses audible but short",
    accent: "",
    scene: "A close-mic whisper for a reveal or suspicious meme.",
    energy: 1,
    sampleText: "[whispers] Есть одна деталь. [short pause] И после нее все становится хуже.",
  },
  {
    id: "friendly-explainer",
    label: "Дружелюбный разбор",
    voice: "Charon",
    style: "friendly explainer with clear structure and calm confidence",
    pace: "medium; clear first sentence, then a small pause, then conclusion",
    accent: "",
    scene: "A concise explanatory voiceover for an interesting short.",
    energy: 3,
    sampleText: "Сначала это выглядит случайностью. [short pause] Но здесь есть маленькая логика.",
  },
  {
    id: "meme-gossip",
    label: "Сплетня из чата",
    voice: "Aoede",
    style: "breezy chat gossip tone, playful and quick",
    pace: "fast but not rushed; smile through the line",
    accent: "",
    scene: "A light chatty voiceover for a social meme.",
    energy: 4,
    sampleText: "[laughs] Я не хотел это обсуждать. [short pause] Но раз уж мы все здесь.",
  },
  {
    id: "strict-narrator",
    label: "Строгий диктор",
    voice: "Orus",
    style: "firm narrator, controlled and slightly severe",
    pace: "medium; emphasize cause and consequence",
    accent: "",
    scene: "A firm voiceover for a direct, no-nonsense short.",
    energy: 3,
    sampleText: "Правило простое. [short pause] Если план звучит слишком идеально, проверь детали.",
  },
  {
    id: "calm-night",
    label: "Ночной спокойный",
    voice: "Achernar",
    style: "soft calm night narrator, warm and slow",
    pace: "slow; relaxed, with clean pauses",
    accent: "",
    scene: "A quiet late-night voiceover for calm Shorts.",
    energy: 1,
    sampleText: "[very slow] Иногда весь смысл появляется только в конце.",
  },
] as const;
