              ...
              <Panel title="Генерация" icon="music">
                ...
                {result ? (
                  <div className="space-y-3">
                    <PrettyAudioPlayer src={result.audioDataUrl} label={`${result.voice} · ${result.languageLabel}`} durationHint={result.durationSec} />
          ...
          return (
            <article key={character.id} className="rounded-md border border-base-300 bg-base-100 p-3 shadow-sm">
              <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_210px_120px] lg:items-end">
                ...
                <PrettyAudioPlayer src={character.sampleUrl} label={`${character.voice} · ${formatDuration(character.sampleDurationSec)}`} durationHint={character.sampleDurationSec} compact />
