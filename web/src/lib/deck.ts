...
export const DECK_GLOSS_RU: Record<string, string> = {
  ...
  "funny-quotes-ru": "Смешные цитаты · рус.",
  "funny-quotes-en": "Смешные цитаты · англ.",
  "funny-quotes-it": "Смешные цитаты · итал.",
  "funny-quotes-es": "Смешные цитаты · исп.",
  "funny-quotes-fr": "Смешные цитаты · фр.",
  "funny-quotes-pt": "Смешные цитаты · порт.",
  "funny-quotes-de": "Смешные цитаты · нем.",
