...
export const DECKS: Deck[] = [
  ...
  },
  {
    id: "ja",
    name: "日本の笑い話",
    dir: "data/anecdotes-ja",
    source: "Translated/adapted from this project's own RU anecdote corpus (data/anecdotes/titled.json); only anecdotes without untranslatable wordplay, without Russia-specific cultural dependencies, and safe for general audience were selected — see data/anecdotes-ja/sources.json",
    emoji: "😂",
    hashtags: "#笑い話 #ジョーク #お笑い #面白い #shorts",
    tags: ["笑い話", "ジョーク", "お笑い", "面白い", "小話", "shorts"],
    genericTitles: ["笑い話", "面白い話", "小話", "今日の一笑", "クスッと笑える話"],
    adminOnly: true,
    grantable: true,
    gallery: true,
    audioProfile: "jokes",
  ...
  },
  {
    id: "shortrobot1",
    name: "shortrobot1",
    dir: "data/shortrobot1",
    source: "Owner-authorized videos imported from tmp/channel-103-rofls-inbox; see data/shortrobot1/sources.json",
    emoji: "😂",
    hashtags: "#мемы #юмор #приколы #смешно #shorts",
    tags: ["мемы", "юмор", "приколы", "смешное", "shortrobot1", "shorts"],
    genericTitles: ["shortrobot1", "Смешное видео", "Мем дня"],
    adminOnly: true,
    grantable: true,
    preFact: true,
    sequential: true,
  ...
  {
    id: "telegram-circles",
    name: "Telegram-кружочки",
    dir: "",
    source: "",
    emoji: "⭕",
    hashtags: "#телеграм #кружочки #головоломка #shorts",
    tags: ["telegram", "кружочки", "головоломка", "shorts"],
    genericTitles: ["Telegram-кружочки"],
    adminOnly: true,
    liveVideo: true,
  },
];
