...
const BASE = {
  "--stage-inset": "86px 58px 334px 58px",
  "--stage-radius": "58px",
  "--stage-bg": "rgba(255, 252, 240, 0.9)",
  "--stage-angle": "155deg",
  "--body-left": "124px",
  "--body-top": "500px",
  "--body-width": "760px",
  ...
  "--text-size": "46px",
  "--text-lh": "1.2",
  "--split-title-width": "330px",
  "--split-title-height": "300px",
  "--split-title-size": "54px",
  "--split-body-top": "430px",
  "--split-body-height": "840px",
  "--label-title-height": "132px",
  "--label-body-top": "448px",
  "--label-body-height": "830px",
  "--scrim-a": "rgba(10, 12, 18, 0.1)",
  "--scrim-b": "rgba(250, 247, 239, 0.2)",
};
